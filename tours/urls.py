...
urlpatterns = [
    ...
    path('destination', views.IndexDestinasiController.as_view(), name="destination"),
    path('destination/<int:page>', views.IndexDestinasiController.as_view(), name="destination_list"),
